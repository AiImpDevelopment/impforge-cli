# Insurance Backend (Postgres 17)

Postgres 17 backend with insurance-flavored seed migration (policy, claim, reserve_calc) and read-replica routing default.

**Industry:** `insurance`  ·  **Category:** `backend`  ·  **Framework:** `rust-1.95`  ·  **License:** `MIT`

## Compliance

This template ships **100** Crown-Jewel compliance rules across the following regimes:

> NAIC, SOLVENCY-II, GDPR, SOC2, ISO-27001
