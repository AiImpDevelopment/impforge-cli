# Aerospace Backend (Postgres 17)

Postgres 17 backend with aerospace-flavored seed migration (aircraft, maintenance_log, airworthiness_directive) for FAA / EASA continuing airworthiness.

**Industry:** `aerospace`  ·  **Category:** `backend`  ·  **Framework:** `rust-1.95`  ·  **License:** `MIT`

## Compliance

This template ships **100** Crown-Jewel compliance rules across the following regimes:

> FAA-PART-145, AS9100, GDPR, SOC2
