# PropTech Tenant / Owner Portal Web (Svelte 5)

Svelte 5 + Tailwind 4 + Bits UI scaffold for tenant self-service, rental applications, and owner dashboards with Fair Housing + FCRA + ECOA awareness.

**Industry:** `proptech`  ·  **Category:** `web`  ·  **Framework:** `svelte-5`  ·  **License:** `MIT`

## Compliance

This template ships **100** Crown-Jewel compliance rules across the following regimes:

> FAIR-HOUSING, FCRA, ECOA, ADA-TITLE-III, GDPR, CCPA, WCAG
...
The preview is reachable at `http://localhost:5173` once it's ready.
