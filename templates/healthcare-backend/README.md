# Healthcare Backend (Postgres 17)

Postgres 17 backend with HIPAA-aware seed migration (phi_access_log, consent_record, encryption_audit) and read-replica routing default.

**Industry:** `healthcare`  ·  **Category:** `backend`  ·  **Framework:** `rust-1.95`  ·  **License:** `MIT`
