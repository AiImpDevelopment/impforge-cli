# Manufacturing Backend (Postgres 17)

Postgres 17 backend with manufacturing-flavored seed migration (work_order, bom_revision, quality_inspection) and read-replica routing default.

**Industry:** `manufacturing`  ·  **Category:** `backend`  ·  **Framework:** `rust-1.95`  ·  **License:** `MIT`
